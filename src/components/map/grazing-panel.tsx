  ...
  return (
    <div className="relative h-full">
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-[1000] flex h-14 w-14 items-center justify-center rounded-full bg-emerald-600 text-white shadow-lg transition hover:bg-emerald-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2"
      ...
      {actionsOpen && (
        <button
          type="button"
          className="fixed inset-0 top-[49px] z-[999] bg-emerald-950/30"
      ...
      <section
        className={`fixed inset-x-0 bottom-0 z-[1000] max-h-[75dvh] overflow-y-auto rounded-t-2xl border-t border-emerald-200 bg-white p-4 shadow-2xl transition-transform duration-300 ease-out ${
